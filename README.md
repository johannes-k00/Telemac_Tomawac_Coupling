...
Step 4: Generate 2D JONSWAP Boundary Spectrum (.spe)
        ...
        Processing: Computes 1D JONSWAP spectra ($\gamma = 3.3$) via mhkit, applies a $\cos^2$ directional spreading function, formats variable naming (F...PT2D...), and writes the binary SELAFIN boundary file.Output: boundary_jonswap.spe
